...
export function InspectorSidebar({ selectedDetails, visibleResults, selectedPath, summary, algorithm, onSelectPath }: InspectorSidebarProps) {
  return (
    <aside className="w-full border-t border-black/5 bg-[var(--surface)] xl:w-96 xl:flex-shrink-0 xl:overflow-y-auto xl:border-l xl:border-t-0">
